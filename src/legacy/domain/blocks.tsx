  ...
  play: [
    { type:"act",      label:"Акт",              hotkey:"0", spell:false, ph:"АКТ ПЕРВЫЙ",
      ...
      st:{ textTransform:"uppercase", fontWeight:"bold", color:"#f0ece0",
           textAlign:"center", paddingTop:"48px", paddingBottom:"16px",
    ...
    { type:"scene",    label:"Сцена",             hotkey:"1", spell:false, ph:"",
      next:"cast",
      st:{ fontWeight:"bold", color:"#c8c4e0", paddingTop:"28px", paddingBottom:"8px",
    ...
    { type:"cast",     label:"Действующие лица", hotkey:"2", spell:false, ph:"Действующие лица сцены...",
      next:"stage",
      st:{ color:"#8886aa", paddingTop:"8px", paddingBottom:"8px", lineHeight:PLAY_TYPO.headingLineHeight, fontStyle:"italic" } },
    { type:"stage",    label:"Ремарка",          hotkey:"3", spell:true,  ph:"Описание места, обстановки...",
      next:"line",
      st:{ fontStyle:"italic", color:"#7a789a", paddingTop:"20px", paddingBottom:"12px", lineHeight:PLAY_TYPO.bodyLineHeight } },
    { type:"line",     label:"Реплика",          hotkey:"4", spell:true,  ph:"текст реплики...",
      next:"line",
      st:{ paddingTop:"10px", paddingBottom:"6px", lineHeight:PLAY_TYPO.bodyLineHeight } },
    { type:"spacer",   label:"Отступ",           hotkey:"6", spell:false, ph:"",
      next:"spacer",
      st:{ paddingTop:"0", paddingBottom:"0" } },
    { type:"note",     label:"Комментарий",      hotkey:"5", spell:true,  ph:"Авторское примечание...",
      next:"stage",
      st:{ color:"#4a4a6a", fontStyle:"italic", paddingTop:"18px", paddingBottom:"8px" } },
  ],
  short: [
