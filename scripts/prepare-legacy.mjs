...
/** Source HTML embeds the whale as a huge data URL; Vite should resolve the PNG as a normal asset. */
merged = merged.replace(/^const LOGO_B64 = "data:image\/png;base64,[^"]+";?\r?\n/m, "");
merged = merged.replace(/\bLOGO_B64\b/g, "logoWhaleMain");
