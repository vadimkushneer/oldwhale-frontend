          ...
          <div className="editor-document__inner">
            {mode === "note" && (
              <EditorDocumentNote
                projectId={projectId}
                spellOn={spellOn}
                externalNoteEditorRef={noteEditorRef}
                noteTextRef={noteTextRef}
                noteSelRangeRef={noteSelRangeRef}
                setNoteText={setNoteText}
                markDirty={markDirty}
                scheduleNoteHistorySnapshot={scheduleNoteHistorySnapshot}
                noteColorOpen={noteColorOpen}
                setNoteColorOpen={setNoteColorOpen}
                noteAlignOpen={noteAlignOpen}
                setNoteAlignOpen={setNoteAlignOpen}
                noteAlign={noteAlign}
                setNoteAlign={setNoteAlign}
